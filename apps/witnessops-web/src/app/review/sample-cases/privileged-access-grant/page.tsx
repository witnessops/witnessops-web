...
export const metadata: Metadata = {
  ...
  description:
    "Named sample case showing how WitnessOps reviews a privileged access grant path: authority, execution, evidence, replayability, and failure modes. This is a published sample case, not a live customer artifact.",
        ...
        <div className="space-y-8">
          <section className="space-y-4 border-b border-surface-border pb-8">
            ...
            <p className="text-base leading-8 text-text-secondary">
              ...
              review a privileged access grant path. It is a stable explanatory
