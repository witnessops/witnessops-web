...
const routes = [
  ["Chcę rozpocząć przegląd", "/pl/review/request", "Opisz sytuację bez sekretów i wybierz ofertę."],
  ["Mam istniejące zgłoszenie", "#contact", "Napisz z tego samego adresu służbowego i podaj identyfikator zgłoszenia."],
  ["Potrzebuję pomocy ze sprawdzeniem dostawy", "/pl/verify", "Sprawdź potwierdzenie albo zadaj pytanie o wynik i ograniczenia."],
