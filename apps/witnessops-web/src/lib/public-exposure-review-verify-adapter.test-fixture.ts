...
export function makePublicExposureReviewReceipt(): Record<string, unknown> {
  ...
  return {
    ...
    verification_context: {
      ...
      limitations: [
        ...
        "production_signing_key_authorization_not_evaluated",
      ],
    },
    result: {
    ...
    // proof-engine build_receipt serializes comparison checks alphabetically.
