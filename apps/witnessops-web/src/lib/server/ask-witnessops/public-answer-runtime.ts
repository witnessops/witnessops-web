...
const INSTRUCTIONS = [
  ...
  "Treat operator model and legacy receipt-profile docs as scoped references, not universal app capability or deployed-control claims. Distinguish Owner/Viewer permissions from operator/approver responsibilities, unsigned snapshots from signed packages, and reports from source evidence. Use app onboarding, results and access-help sources for app questions.",
