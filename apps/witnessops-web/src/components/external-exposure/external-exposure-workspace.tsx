  ...
  return <>{printRoot}<main id="main-content" className={styles.workspace}>
    <div className={styles.screen}>
      ...
      {result && <>
        ...
        <section className={styles.nextStep} aria-label="Save a persistent baseline"><div><h2>Save this baseline</h2><p>Keep this observation, rerun later, and see what changed.</p><p className={styles.muted}>Early Access starts with a fresh, explicitly authorized saved observation. This transient snapshot is not automatically imported.</p></div><a className={styles.primaryLink} href="/early-access">Save this baseline</a></section>
