  ...
  return <>{printRoot}<main id="main-content" className={styles.workspace}>
    <div className={styles.screen}>
      ...
      {result && <>
        ...
        <section className={styles.nextStep} aria-label="Save a persistent baseline"><div><h2>Keep a history in your workspace</h2><p>Start a saved check, keep its evidence and report, then run again later to compare.</p><p className={styles.muted}>Early Access starts with a fresh, explicitly authorized saved observation. This transient snapshot is not automatically imported.</p></div><a className={styles.primaryLink} href="/early-access">Start a saved check</a></section>
