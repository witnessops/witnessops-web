...
import { BuyerReportDocument, type ReportFollowThrough } from './buyer-report';
...
export function useBuyerReportPrint(model: ProofpackReportV1 | null, followThrough?: ReportFollowThrough) {
  ...
  return {
    ...
    printRoot: body && admitted ? createPortal(
      <div className={styles.root} data-buyer-print-root><BuyerReportDocument model={model} followThrough={followThrough} /></div>, body,
    ) : null,
  };
}
