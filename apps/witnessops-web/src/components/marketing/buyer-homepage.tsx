...
const localizedCopy = {
  en: {
    ...
    commercialLine: "€1,900 ex VAT · delivery within 24 hours after accepted start conditions · 1 authorised public-facing system",
  ...
  pl: {
    ...
    commercialLine: "€1 900 netto · dostawa w ciągu 24 godzin po spełnieniu zaakceptowanych warunków startu · 1 autoryzowany system publicznie dostępny",
