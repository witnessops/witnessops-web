...
- Request-kind continuity: External Attack Surface Review records retain their payment, SOW, written-authority, fixed-scope, required-input, evidence-handling, and collection-window gates and link to the matching synthetic sample.
