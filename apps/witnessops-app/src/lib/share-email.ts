...
export function reportEmail(origin: string, token: string, recipient: string, snapshot: RecipientReport, expires: Date, id: string): TextEmailPayload {
