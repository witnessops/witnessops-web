import { reportLinkBase } from './report-host';
...
export function reportEmail(origin: string, token: string, recipient: string, snapshot: RecipientReport, expires: Date, id: string, passwordProtected=false,name?:string): TextEmailPayload {
