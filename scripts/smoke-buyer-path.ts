...
export const buyerPathSmokeRoutes: BuyerPathSmokeRoute[] = [
  {
    ...
    requiredMarkers: [
      ...
      "See what your public system exposes.",
      "One authorised public-facing domain. Three working days. €1,900 ex VAT.",
      "Order a Public Exposure Review",
      ...
      "How it works",
      "Why WitnessOps",
      "Check one domain. See the evidence.",
    ],
    prohibitedMarkers: [
  ...
  },
  {
    ...
    requiredMarkers: [
      "Public Exposure Review",
      "Know what one public domain exposes",
      "€1,900 ex VAT",
      "No sales call required.",
      "Within 3 working days",
      "one authorised registrable root domain",
  ...
  },
  {
    ...
    requiredMarkers: [
      ...
      "Submit one public domain and your authority",
      "No sales call is required",
      "Public domain to review",
      "Authority to request this review",
      "Submit order for scope acceptance",
