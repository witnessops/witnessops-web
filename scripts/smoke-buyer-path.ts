...
export const buyerPathSmokeRoutes: BuyerPathSmokeRoute[] = [
  {
    ...
    requiredMarkers: [
      ...
      "What we don't do",
      "See an example",
      "Don't take the record on trust. Check it yourself.",
      "does not prove that a finding is true",
      "Who is behind it",
      "Karol on LinkedIn",
      "See what the internet sees.",
    ],
  ...
  },
  {
    ...
    requiredMarkers: [
      ...
      "Full payment is recommended; two €950 instalments are available by agreement after scope acceptance.",
      "Payment alone does not authorise testing.",
  ...
  },
  {
    ...
    requiredMarkers: [
      ...
      "Rozpocznij przegląd",
      "Zobacz przykład",
      "Syntetyczny przykład — nie są to materiały klienta",
      "F-003",
      "E-003",
      "Co robimy",
      "Czego nie robimy",
      "Nie wierz zapisowi na słowo. Sprawdź sam.",
      "Kto za tym stoi",
      "Karol na LinkedIn",
  ...
  },
  {
    ...
    requiredMarkers: [
      ...
      "W ciągu 24 godzin po potwierdzeniu uzgodnionego warunku płatności",
