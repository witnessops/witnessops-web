...
export const buyerPathSmokeRoutes: BuyerPathSmokeRoute[] = [
  {
    ...
    requiredMarkers: [
      ...
      "For SaaS teams facing an enterprise security request",
      "€1,500 paid pilot · 3 working days · 1 public-facing domain/application",
      "Start a review",
      "View sample",
  ...
  },
  {
    ...
    requiredMarkers: [
      ...
      "Dla zespołów SaaS przed wymaganiem bezpieczeństwa klienta enterprise",
      "Rozpocznij ocenę",
      "Zobacz przykład",
  ...
  },
  {
    ...
    requiredMarkers: [
      ...
      "One public-facing domain or application, with up to 10 first-party hostnames",
  ...
  },
  {
    ...
    requiredMarkers: [
      ...
      "Start a review",
      "€1,500 paid pilot for one public-facing domain or application",
