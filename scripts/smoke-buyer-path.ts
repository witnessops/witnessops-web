...
export const buyerPathSmokeRoutes: BuyerPathSmokeRoute[] = [
  {
    ...
    requiredMarkers: [
      "WitnessOps",
      "<title>Agent Workflow Reconstruction | WitnessOps</title>",
      ...
      "Reconstruct the workflow, not only the file.",
    ...
    prohibitedMarkers: [
      ...
      "Check a skill",
      "Aegis",
      "Agent Workflow Reconstruction | WitnessOps | WitnessOps",
    ],
  },
  {
    path: "/catalog",
  ...
  },
  {
    ...
    requiredMarkers: [
      "Agent Workflow Reconstruction",
      "One consequential workflow. Reconstructed so another person can inspect it.",
      "One consequential agent or automation workflow needs a reconstructable account of what was authorised, executed, observed, and still unresolved.",
      "€2,500 fixed",
      "Non-secret fit check first",
      "One named workflow (agentic or automated)",
      "Within 10 working days after evidence rules are agreed",
  ...
  },
  {
    ...
    requiredMarkers: [
      ...
      "€2,500 fixed",
      "within 10 working days after evidence rules are agreed",
      "secondary catalogue work at €1,900 ex VAT",
    ],
    prohibitedMarkers: [
      "Agent Risk &amp; Control Review",
      "Agent Risk & Control Review",
  ...
  },
  {
    ...
    requiredMarkers: [
      ...
      "/verify/skill",
      "Agent Workflow Reconstruction",
      "Odtwórz workflow, nie tylko plik.",
      ...
      "Przykładowy pakiet z obsługiwanym zapisem JSON do wyodrębnienia i sprawdzenia przez /verify",
      "Omówienie wyniku",
      "€2 500 — cena stała",
  ...
  },
  {
    ...
    requiredMarkers: [
      ...
      "€2,500 fixed",
      "Name one consequential agent or automation workflow.",
      "One consequential agent or automation workflow needs a reconstructable account of what was authorised, executed, observed, and still unresolved.",
      "one named workflow (agentic or automated)",
      "Non-secret fit check first",
      "Within 10 working days after evidence rules are agreed",
      "What Agent Workflow Reconstruction includes",
  ...
  },
  {
    ...
    requiredMarkers: [
      "Zgłoś: Agent Workflow Reconstruction",
      "€2 500 — cena stała",
      "Nazwij jeden istotny workflow agenta lub automatyzacji.",
      "Jeden istotny workflow agenta lub automatyzacji wymaga odtwarzalnego zapisu tego, co zatwierdzono, wykonano, zaobserwowano i co nadal pozostaje nierozstrzygnięte.",
      "Jeden nazwany workflow (agentowy lub zautomatyzowany)",
      "Najpierw wstępna ocena bez informacji poufnych",
      "W ciągu 10 dni roboczych po uzgodnieniu zasad dowodowych",
      'name="intent" value="bounded-workflow-review"',
