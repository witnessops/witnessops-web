...
export const buyerPathSmokeRoutes: BuyerPathSmokeRoute[] = [
  ...
  },
  {
    path: "/catalog",
    requiredMarkers: [
      "Start with the situation you need to move forward.",
      "Customer Security Review Sprint",
      "Three working days after scope, owners and required evidence access are confirmed",
      "Bounded Workflow Review",
      "One Server Security Check",
      "€950 standard after a non-secret fit check",
      "Within two business days after the authorized collection window closes",
      "Launch Readiness Check",
      "Four business days after candidate evidence collection",
      "Key, Access and Custody Review",
      "Incident Readiness Review",
      "Start a review",
    ],
    prohibitedMarkers: ["Pilot (entry)", "€500–€1,500"],
  },
  {
    path: "/docs",
    requiredMarkers: [
  ...
  },
  {
    ...
    requiredMarkers: [
      ...
      "Opowiedz nam, co wymaga sprawdzenia.",
      "Zobacz usługi",
      "Rozpocznij zgłoszenie",
      "Sześć przeglądów dla pracy, która wymaga jasnego następnego kroku",
      "Przegląd bezpieczeństwa jednego serwera",
      "Przegląd zarządzania kluczami, dostępem i pieczą",
    ],
    prohibitedMarkers: ["Pilotaż przeglądu bezpieczeństwa 10 serwerów"],
  },
  {
    path: "/pl/catalog",
    requiredMarkers: [
      "Zacznij od sytuacji, którą chcesz rozwiązać.",
      "Customer Security Review Sprint",
      "Od 1 600 € po niepoufnej ocenie dopasowania",
      "Trzy dni robocze od potwierdzenia zakresu, osób odpowiedzialnych i dostępu do wymaganych materiałów.",
      "Przegląd działania o jasno określonym zakresie",
      "Od 1 500 €",
      "Przegląd bezpieczeństwa jednego serwera",
      "950 € — cena standardowa po niepoufnej ocenie dopasowania",
    ...
    prohibitedMarkers: [
      ...
      "Dopuszczalny zakres: 500–1 500 €",
    ],
  },
  {
    path: "/pl/customer-security-review",
    requiredMarkers: [
      "Sprint odpowiedzi na kwestionariusz bezpieczeństwa klienta",
      "Od 1 600 €",
      "trzech dni roboczych",
      "Przekaż kwestionariusz do wstępnej oceny dopasowania i zakresu.",
      "SYNTHETIC DEMONSTRATION — NOT CUSTOMER EVIDENCE",
      "Nie gwarantujemy zatwierdzenia przez przedsiębiorstwo ani zamknięcia transakcji.",
    ],
    prohibitedMarkers: [
      "verified compliance",
      "certified compliance",
