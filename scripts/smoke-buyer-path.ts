...
export const buyerPathSmokeRoutes: BuyerPathSmokeRoute[] = [
  {
    ...
    requiredMarkers: [
      ...
      "Inspect the public evidence sample",
    ],
    prohibitedMarkers: [
  ...
  },
  {
    ...
    requiredMarkers: [
      ...
      "Opublikowany przykład — nie są to materiały klienta",
      "witnessops/witnessops-sample-cases",
      "99741c8d50cd",
      "pass_with_sample_limitations",
      ...
      "Zobacz publiczny przykład materiałów",
    ],
    prohibitedMarkers: [
      "Public Exposure Review",
      "Bounded Workflow Review",
