...
export const buyerPathSmokeRoutes: BuyerPathSmokeRoute[] = [
  {
    ...
    requiredMarkers: [
      ...
      "Five questions. One consequential action.",
      ...
      "Agent Action Security Review",
      "Review production authority before the agent acts.",
    ...
    prohibitedMarkers: [
      ...
      "Check a skill",
      "Aegis",
      "Agent Action Security Review | WitnessOps | WitnessOps",
    ],
  },
  {
    path: "/catalog",
  ...
  },
  {
    ...
    requiredMarkers: [
      "Agent Action Security Review",
      "What can your AI agent actually do in production?",
      "moves from suggesting to acting",
      "before a customer, pentest, or incident finds the gaps for you",
      "€2,500 fixed",
      "Non-secret fit check first",
      "One consequential agent or automation action",
  ...
  },
  {
    ...
    requiredMarkers: [
      ...
      "d4ad234bd815",
      "VALID_SYNTHETIC_SPECIMEN",
      "Pięć pytań. Jedno istotne działanie.",
      "Kto może je zatwierdzić?",
      "Jaka tożsamość je wykonuje?",
      "Do czego ma dostęp?",
      "Co ogranicza zasięg skutków?",
      "Jaki ślad dowodowy pozostaje?",
      "Agent Action Security Review",
      "Sprawdź uprawnienie produkcyjne, zanim agent zacznie działać.",
  ...
  },
  {
    ...
    requiredMarkers: [
      "Start your External Attack Surface Review",
      "Tell us which authorised internet-facing system needs an external attack-surface review",
  ...
  },
  {
    ...
    requiredMarkers: [
      "Zgłoś: Agent Action Security Review",
      "€2 500 — cena stała",
