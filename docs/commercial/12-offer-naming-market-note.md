...
| Bounded Workflow Review | No stable buyer category was established in the sampled results; the current wording covers several different triggers. | Keep out of flagship positioning. Name a narrower offer only when one repeatable workflow becomes commercially active. |
