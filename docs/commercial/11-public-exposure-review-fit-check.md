...
- The deadline allows three working days after payment, accepted SOW, authority, scope freeze, required inputs, and the approved collection window are confirmed.
...
The fixed fee is €1,900 excluding VAT. Delivery is due within three working days after
payment, accepted SOW, authority, scope, required inputs, and the collection window are
confirmed. One focused retest within 30 days is included.
