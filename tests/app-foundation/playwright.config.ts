...
export default defineConfig({
  ...
  webServer: {
    ...
    env: { WITNESSOPS_APP_BROWSER_TEST: "1", WITNESSOPS_REPORT_HOST_SUFFIX: "proof.example.test", WORKOS_API_KEY: "test-only-no-network", WORKOS_CLIENT_ID: "client_browser_fixture", WORKOS_COOKIE_PASSWORD: "test-only-cookie-material-not-a-real-secret", NEXT_PUBLIC_WORKOS_REDIRECT_URI: "http://127.0.0.1:3022/callback", WORKOS_COOKIE_DOMAIN: "", WORKOS_COOKIE_SAMESITE: "lax" },
