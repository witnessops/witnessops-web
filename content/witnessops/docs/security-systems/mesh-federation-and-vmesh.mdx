...
- WitnessOps `/verify` receipt-only checks (PV/QV/WV compatibility plus current product profiles)
...
| `/verify` | Receipt-only v1 scope on the public verifier | Proof packages remain outside this input boundary |
