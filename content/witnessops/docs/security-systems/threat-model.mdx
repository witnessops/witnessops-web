...
description: "What WitnessOps can prove, what it assumes, and how verification and disputes should be handled when proof claims are challenged."
section: "docs"
order: 40
...
Proof artifacts are often over-read. Teams need a precise boundary statement for what is actually proven, what remains assumed, and how to handle disputes when proof claims are challenged.

## 2. What you should understand after reading

This page makes four outcomes explicit:
...
Next, read [Authorization Model](/docs/governance/authorization-model) for approval and authority boundaries that sit above this threat model.

Then use these as needed:

- [Verification](/docs/how-it-works/verification) for check procedure
- [Receipt Specification](/docs/evidence/receipt-spec) for technical receipt contract
