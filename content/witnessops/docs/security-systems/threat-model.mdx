...
- [Governed Execution](/docs/security-systems/governed-execution) for the runtime control path
- [Receipts](/docs/evidence/receipts) for what the atomic proof object means
