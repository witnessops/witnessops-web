...
| Timestamp layer | Digest of signed receipt envelope | Existence-before-time **only if** the RFC 3161 token and TSA chain fully verify (not structural field presence alone in receipt-first mode) |
