...
This page answers one practical question: how to verify a receipt or proof bundle offline, and how to read `valid`, `invalid`, and `indeterminate` results without claiming too much.
...
1. **Confirm the artifact set.** Determine whether you have receipt-only material or a proof bundle.
