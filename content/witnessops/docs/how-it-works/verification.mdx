...
description: "Run the public receipt-only check, understand legacy public_exposure_review indeterminate semantics, and keep full-package verification separate."
section: "docs"
order: 4
...
page_answer:
  question: "What does the public verifier check, why is a legacy public_exposure_review receipt currently indeterminate, and what would full verification require?"
  links:
...
Read [Receipt Specification](/docs/evidence/receipt-spec) for the exact legacy-profile contract and [Evidence Bundles](/docs/how-it-works/evidence-bundles) for the current package boundary.
