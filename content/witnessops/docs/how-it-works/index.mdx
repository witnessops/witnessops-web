---
title: "How It Works"
description: "How free checks, invited app workspaces, optional CLI access and expert reviews fit together."
section: "docs"
order: 1
...
- **Saved workspace observations:** [Create a free account](/docs/getting-started), then use an invited workspace. Signup creates no workspace membership or permission to execute checks. The browser app needs no installation.
- **Your first app result:** follow [Your first observation](/docs/getting-started/first-observation), then [Understand results and reports](/docs/getting-started/results). Owners authorize supported checks; Viewers inspect accessible data.
