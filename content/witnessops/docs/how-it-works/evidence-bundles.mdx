...
description: "The current External Attack Surface Review package boundary, reconstructable manifest references, and the separation between producer output and independent verification."
section: "docs"
order: 3
