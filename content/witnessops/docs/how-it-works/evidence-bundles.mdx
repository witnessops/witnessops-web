...
For the current artifact vocabulary and which classes are live, retained-reference, or still planned, see [Proof Artifact Classes](/docs/reference/proof-artifact-classes).
