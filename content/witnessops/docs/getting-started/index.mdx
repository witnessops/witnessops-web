...
description: "Start with the Agent Risk & Control Review buyer path, then inspect the evidence and receipt verification boundaries."
section: "docs"
order: 2
...
The primary homepage offer is [Agent Risk & Control Review](/catalog/workflows): a focused review of one agentic or automated workflow. It maps authority, controls, evidence requirements, a receipt schema, and a verifier path without claiming that a web page or report is itself proof.

The detailed sequence below documents the separate [Public Exposure Review](/catalog/offsec-external-exposure) production workflow. That offer remains current in the catalogue; it is no longer the homepage lead.
