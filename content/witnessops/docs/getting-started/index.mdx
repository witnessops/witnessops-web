...
description: "Start with Agent Workflow Reconstruction, then inspect the evidence and receipt verification boundaries."
section: "docs"
order: 2
...
The primary paid entry point is [Agent Workflow Reconstruction](/catalog/workflows): one named agentic or automated workflow, €2,500 fixed. It begins with a non-secret fit check and is delivered within 10 working days after evidence rules are agreed. The reconstruction separates what was authorised, executed, observed, and still unresolved without claiming that a web page or report is itself proof.

The detailed sequence below documents the separate [Public Exposure Review](/catalog/offsec-external-exposure) production workflow. That €1,900 ex VAT, three-working-day offer remains available as secondary catalogue work; it is not the primary paid entry point.
...
## 1. Public Exposure Review sequence
