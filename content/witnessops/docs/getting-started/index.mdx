...
If you are evaluating the public request path before submitting a workflow, read the [Security Workflow Buyer Path](/docs/getting-started/proof-run-buyer-path).
