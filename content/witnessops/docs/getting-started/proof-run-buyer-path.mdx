...
Read [View services](/catalog) first. For the questionnaire offer, see [Customer Security Review Sprint](/customer-security-review) (from €1,600 after a non-secret fit check; English and Polish one-pagers are linked from that page and the catalogue).
...
Open [AI-agent sample package](/review/sample-cases/ai-agent-action-proof-run) or other [sample cases](/review/sample-cases).
...
1. [View services](/catalog)  
2. [Customer Security Review Sprint](/customer-security-review) (if relevant)  
3. [Sample cases](/review/sample-cases)  
4. [Verify a receipt](/verify)  
