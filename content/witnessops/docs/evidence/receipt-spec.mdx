...
- The public `/verify` surface is receipt-first v1. It accepts supported receipt JSON and returns a receipt-scoped result.
- Bundle-complete verification evaluates the receipt in the context of the canonical proof bundle around it.
