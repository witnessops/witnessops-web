...
description: "Authoritative technical diligence page for WitnessOps Receipt v2, proof references, and the current verification model."
section: "docs"
order: 4
...
If you need the conceptual overview first, start with [Receipts](/docs/evidence/receipts). If you need the operator workflow, go to [Verification](/docs/how-it-works/verification).
...
5. enough linkage to let a verifier connect the receipt to the bundle and chain around it
