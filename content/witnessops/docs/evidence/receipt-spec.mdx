...
description: "Current WitnessOps receipt contracts, the legacy public_exposure_review profile, and the bounded checks performed by the public verifier."
section: "docs"
order: 4
nav_label: "Receipt Spec"
draft: false
page_answer:
  question: "Which receipt contracts are current, what does the legacy public_exposure_review profile require, and what can the public verifier assert?"
  links:
