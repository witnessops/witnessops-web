...
description: "How chained receipts become continuity, portable bundles, and a verifiable order of operations."
section: "docs"
order: 3
...
Next, read [Sensitive Artifact Handling](/docs/evidence/sensitive-artifact-handling) to apply stricter controls to raw credentials, tokens, and other high-risk artifacts that may accompany chain evidence.
