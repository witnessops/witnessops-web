...
description: "Operator reference: How the WitnessOps catalog describes available governed execution capabilities."
section: "docs"
order: 2
...
| --- | --- | --- |
| Definition layer | Declares capability contract, version, and required governance metadata | Claiming a specific execution met real-world objectives |
| Runtime layer | Provides the reference contract used to evaluate execution conformance | Environment stability, remote system truth, or tool correctness |
| Operational judgment | Supplies bounded terms for interpreting run outcomes | Final risk significance without human review |
