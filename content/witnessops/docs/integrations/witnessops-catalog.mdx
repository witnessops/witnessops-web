...
Next, read [Execution Chains](/docs/evidence/execution-chains) for how receipt-level events are connected into continuity that can be verified as an ordered proof story.
