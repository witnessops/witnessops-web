...
**Scope note:** A proof bundle transports proof artifacts; it is not itself a guarantee that all external trust assumptions hold.
...
**Scope note:** Witness semantics belong to verification/trust layers, not to core execution-runtime control.

## Next-page handoff

For operator-facing command semantics and route-level runtime/receipt behavior, continue to [man witnessops(7)](/docs/man/witnessops).
