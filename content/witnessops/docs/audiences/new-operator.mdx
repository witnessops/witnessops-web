...
If you operate on the **WitnessOps mesh** (fleet VM, bastion, goal0-edge), start
with the published operator bundle at
[hacktheworld.zip/mesh-docs/](https://hacktheworld.zip/mesh-docs/) for hunt sync,
DNS, and deploy truth. This docs site remains the **buyer and doctrine** layer.
