---
title: "New Operator"
description: "Operator reference: Start here if you are doing hands-on security work and need to understand scope, workflows, evidence, and escalation."
section: "docs"
order: 10
...
If you operate on the **WitnessOps mesh** (fleet VM, bastion, goal0-edge), use
**internal** mesh operator documentation for hunt sync, DNS, and deploy truth.
That material is not published on this public docs site. This site remains the
**buyer and doctrine** layer.
