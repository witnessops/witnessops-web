...
| Escalation trigger | Escalate when compromise indicators, privileged exposure, spread potential, or boundary uncertainty exceeds defender authority | [Do I Need to Escalate?](/docs/decisions/escalation), [Authorization Model](/docs/governance/authorization-model) |
| Evidence sufficiency | Ensure case artifacts support later approval, incident review, and post-incident decisions | [What Evidence Is Required?](/docs/decisions/evidence-required), [Evidence](/docs/evidence) |
