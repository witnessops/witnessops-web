...
| Interface contract design | Define stable input/output shape, error semantics, and permission/approval expectations | [Runbooks](/docs/operations/runbooks), [Authorization Model](/docs/governance/authorization-model) |
| Evidence compatibility | Ensure emitted artifacts and metadata can be captured and linked in receipts | [Receipt Spec](/docs/evidence/receipt-spec), [What Evidence Is Required?](/docs/decisions/evidence-required) |
