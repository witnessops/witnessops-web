...
| --- | --- | --- | --- |
| Intake and case binding | Is this report in your authorized intake lane and asset boundary? ([Is This In Scope?](/docs/decisions/scope-check)) | Do you have enough intake context to start (reporter, time, artifact reference)? | Escalate immediately if reporter or target falls outside local authority boundary. |
...
| Classify and choose disposition | Is selected action (warn, quarantine, reset, hold) authorized at your level? | Is classification supported by preserved artifacts and explicit rationale? ([What Evidence Is Required?](/docs/decisions/evidence-required)) | Escalate if required action exceeds local authority or evidence remains insufficient under risk. |
